/**
 * Smart Pen ESP32 v3.0 - Triple Mode Communication
 * Supports USB Serial, WiFi, and Bluetooth Low Energy (BLE)
 * 
 * Author: BadgerPen Team
 * Version: 3.0.0
 * Date: 2024
 */
...
const char* WIFI_SSID = "TRUNG KIEN";               // Your WiFi network name
const char* WIFI_PASSWORD = "";                     // Your WiFi password - UPDATE THIS!
...
void setup() {
  ...
  Serial.println("🦡 Smart Pen ESP32 Triple Mode Starting...");
